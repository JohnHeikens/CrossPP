...
constexpr bool hasFacingData(const blockID &identifier) noexcept {
    return canFaceUp(identifier) || isDoor(identifier) || isStairs(identifier) ||
           ...
           isGlazedTerracotta(identifier)
           || (identifier == blockID::repeater) || (identifier == blockID::comparator) ||
...
constexpr bool attachedToBottomBlock(const blockID &identifier) noexcept {
    return isFarmlandCrop(identifier) || isFlower(identifier) || isGrass(identifier) ||
           ...
           is_in(identifier, blockID::repeater, blockID::comparator, blockID::redstone_wire);
}
...
constexpr blockID getBlockToSpread(const blockID &identifier) noexcept {
    return (identifier == blockID::tall_grass) ? blockID::grass_block :
           ...
           isOverworldLeaves(identifier) ? (blockID) ((int) blockID::wood_sapling +
                                                      (int) getWoodType(identifier)) :
           isRoots(identifier) ? (blockID) ((int) blockID::crimson_nylium +
                                            ((int) identifier - (int) blockID::crimson_roots)) :
           identifier;
}
...
constexpr bool canSpreadOn(const blockID &identifier, const blockID &spreadOn) noexcept {
    return isNylium(identifier) ? (spreadOn == blockID::netherrack) :
           ...
           isFungus(identifier) ? (spreadOn == (blockID) ((int) blockID::crimson_nylium +
                                                          ((int) getWoodType(identifier) -
                                                           (int) woodTypeID::crimson))) :
           isSapling(identifier) ? ((spreadOn == blockID::dirt) ||
                                    (spreadOn == blockID::grass_block) ||
                                    (spreadOn == blockID::podzol)) :
           (spreadOn == blockID::grass_block);
}
