...
layerNoiseSimplex::layerNoiseSimplex(std::mt19937& randomToUse, const std::vector<fp>& octaveWeights, crectangle1& outputRange)
{
	baseNoise = new simplexNoise(randomToUse);//initialize base noise
