...
void loadResourcePacks()
{
	...
	blockList[identifier] = new block((blockID)identifier, -1, -1, standardBlockWeightPerCubicMeter, dragonEggGraphics, std::wstring(L"dragon_egg"), stepStone, stepStone, stepStone, digStone, digStone, lightFiltering, withPickaxe, noHarvestTier, collisionTypeID::willCollideTop, 0, 0, false, false, glowingLightSource);
	identifier++;
