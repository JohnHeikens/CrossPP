...
constexpr fp codTextureScale = codHitboxSize.x() / (codCaudalFinTextureRect.w() + codBodyTextureRect.w() + codHeadTextureRect.w() + codNoseTextureRect.w());
...
constexpr vec2 codHeadRotationCentre = cvec2(0, codHeadSize.y() * 0.5);
constexpr vec2 codNoseRotationCentre = cvec2(0, codNoseSize.y() * 0.5);
constexpr vec2 codDorsalFinsRotationCentre = cvec2(codDorsalFinsSize.x() * 0.5, 0);
constexpr vec2 codCaudalFinRotationCentre = cvec2(codCaudalFinSize.x(), codCaudalFinSize.y() * 0.5);
constexpr vec2 codFrontFinRotationCentre = cvec2(codFrontFinSize.x() * 0.5, codFrontFinSize.y());
