...
#include "dropData.h"
#include "include/math/raycast.h"
...
void mob::tick()
{
	...
	{
		if (wantsToSprint) {
			MovementSpeed = humanSprintFlyingSpeed;
		}
		else
		{
...
bool mob::shouldJump(bool& wantsToGoLeft, bool& wantsToGoRight) const
{
	...
	cfp speedX = ((mobData*)entityDataList[(int)entityType])->walkingSpeed * (wantsToGoLeft ? -1 : wantsToGoRight ? 1 : 0);
